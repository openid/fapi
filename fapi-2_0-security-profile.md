...
For the authorization code flow, clients
 ...
 1. the PKCE challenge shall be specifically generated for each authorization request and securely bound to the client and the user agent in which the flow was started;
